    ...
    <div class="d-flex flex-column">
      <div class="profile">
        ...
        <div class="social-links mt-3 text-center">
          ...
          <a href="https://www.linkedin.com/in/alexcqr/" target="_blank" class="linkedin" title="LinkedIn"><i class="bx bxl-linkedin"></i></a>
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li>
            <a href="/AlexChristianQuispeRoque_Detallado_CV_2022.pdf" target="_blank" class="nav-link scrollto" @click="trackEvent('#curriculumvitae')">
